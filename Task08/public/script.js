...
function masterForm(){
    ...
    let block = `
        <div class='person-info'>
                <label class='rl'> 1. Персональная информация </label><hr><br>
                <input type='text' id='name' placeholder='Имя*'><br>
                <input type='text' id='last-name' placeholder='Фамилия*'><br> 
                <input type='text' id='patronymic' placeholder='Отчество'><br>
                <div class="gender">
                    <p><input type="radio" name='gender' id="male" checked>Мужской</p>
                    <p><input type="radio" name='gender' id="female">Женский</p>
                </div>
                <select id = "specialization">
                    <option value='all'>Специализация*</option>
                </select><br>
                <input type='number' id='percent' placeholder='Коэффициент зарплаты*'><br>
            </div><br>
            <div class="shedule">
                <label class='rl'>2. Графиу работы</label><hr><br>
                <div id="week">
                    ${weekBlock}
                </div>
            </div><br>
            <div class="work-info">
                <label class='rl'> 3. Умения </label><hr><br>
                <div id="lists">
                    
                </div><br>
                <label id='add'>+ умения</label>
            </div><br>
...
function preEntryForm() {
    let block = `
    <div class="according">
        <label > Запись </label><hr><br>
        <select id = "master">
            <option value='all'>Мастер*</option>
        </select><br>
        <select id = "service">
            <option value='all'>Услуга*</option>
        </select><br>
        <select id = "period">
        <option value='all'>Время*</option>
        </select><br>
    </div>
    <input id='submit' type='button' value='записаться'>
    `
    document.getElementById("content").innerHTML = block;
...
function menuON() {
    ...
    <div class='menu-container'>
        <label id=menu-0>Меню</label><br>
        <label id=menu-1>1. Форма мастера</label><br>
        <label id=menu-2>2. Форма записи</label><br>
    </div>
